...
public class MathUtil {
    ...
    public static Rectangle checkForCollidedEntity(EntityBase entity, ArrayList<? extends Rectangle> list) {
        Rectangle futurePosition = new Rectangle(
            (int) (entity.mX + entity.vX),
            (int) (entity.mY + entity.vY),
            entity.width,
            entity.height
        );
    ...
    /** A variation of checkForCollision, except allows you to select which axis' motion gets utilized
     * Used for cases like the player, which may still want to move up or down, even if left or right have collided
     * @param xAxis true for x-axis collision, false for y-axis collision **/
    ...
    /** Checks an entity's future position against a list of collidable tile hitboxes.
     * @param entity The entity to check.
     * @param collidableTiles The list of collidable tiles (as rectangles).
     * @return True if a collision is detected, false otherwise.
     */
    public static boolean checkForCollision(EntityBase entity, List<Rectangle> collidableTiles) {
        Rectangle futurePosition = new Rectangle(
            (int) (entity.mX + entity.vX),
            (int) (entity.mY + entity.vY),
            entity.width,
    ...
    //     // Placeholder for future map bounds collision checking
    // }
}
